                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" rows="3" placeholder="" name="cast">
                                                    ...
                                                    <?php foreach ($cast as $ckey => $cvalue) {
                                                        ?>
                                                        <option value="<?php echo $cvalue ?>" <?php
                                                        if ($cvalue == $student["cast"]) {
                                                            echo "selected";
                                                        }
                                                        ?>><?php echo $cvalue ?></option>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="radio" style="margin-top: 2px;">
                                                <label><input class="radio-inline" type="radio" name="rte" value="Ya"  <?php
                                                              echo set_value('rte', $student['rte']) == "Ya" ? "checked" : "";
                                                              ?>  ><?php echo $this->lang->line('yes'); ?></label>
                                                <label><input class="radio-inline" type="radio" name="rte" value="Tidak" <?php
                                                              echo set_value('rte', $student['rte']) == "Tidak" ? "checked" : "";
