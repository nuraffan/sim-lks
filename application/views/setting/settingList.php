            ...
            <div class="col-lg-10 col-md-9 col-sm-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="">
                        ...
                        <?php //echo site_url('schsettings/ajax_schedit_new')      
                        ?>" class="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('kota'); ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="kota" name="sch_kota" value="<?php echo $result->kota; ?>"><span class="text-danger"><?php echo form_error('kota'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('ketua'); ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="ketua" name="sch_ketua" value="<?php echo $result->ketua; ?>"><span class="text-danger"><?php echo form_error('ketua'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div><!--./row-->
