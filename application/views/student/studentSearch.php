                    ...
                    <div class="">
                        ...
                        ?>
                            <div class="nav-tabs-custom border0">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><i class="fa fa-list"></i> <?php echo $this->lang->line('view'); ?> <?php echo $this->lang->line('list'); ?></a></li>
                                    <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false"><i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('view'); ?> <?php echo $this->lang->line('details'); ?></a></li>
                                    <li>
