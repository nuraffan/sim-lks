            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('student/create') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div class="">
                            <div class="bozero">
                                <h4 class="pagetitleh-whitebg"><?php echo $this->lang->line('admission'); ?> <?php echo $this->lang->line('student'); ?> </h4>
                                <div class="around10">
                                        ...
                                        if ($sch_setting->cast) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" rows="3" placeholder="" name="cast">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                        <?php foreach ($cast as $ckey => $cvalue) {
                                                        ?>
                                                ...
                                                if ($sch_setting->rte) { ?>
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="radio" style="margin-top: 2px;">
                                                            <label><input class="radio-inline" type="radio" name="rte" value="Ya" <?php
                                                                                                                                    echo set_value('rte') == "Ya" ? "checked" : "";
                                                                                                                                    ?>><?php echo $this->lang->line('yes'); ?></label>
                                                            <label><input class="radio-inline" checked="checked" type="radio" name="rte" value="Tidak" <?php
                                                                                                                                                        echo set_value('rte') == "Tidak" ? "checked" : "";
