                    ...
                    <div class="">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label">
                                <?php echo $this->lang->line('profile') . " " . $this->lang->line('student'); ?></div>

                            <!-- Mengambil judul Cetak <?php $this->customlib->get_postmessage(); ?> END-->
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        if ($sch_setting->guardian_occupation) { ?>
                                            <th><?php echo $this->lang->line('guardian_occupation'); ?></th><?php }
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <?php }
                                                if ($sch_setting->mother_name) { ?> <td><?php echo $value['mother_name']; ?></td>
                                                <?php }
                                                if ($sch_setting->mother_phone) { ?>
