...
class Setting_model extends MY_Model
{
    ...
    public function get($id = null)
    {
        ...
        $this->db->select(
          ...
          sch_settings.name,sch_settings.email,sch_settings.biometric,sch_settings.biometric_device,sch_settings.time_format,sch_settings.phone,sch_settings.kota,sch_settings.ketua,languages.language,sch_settings.attendence_type,
    ...
    public function getSchoolDetail($id = null)
    {
        ...
        $this->db->select(
          ...
          sch_settings.name,sch_settings.email,sch_settings.biometric,sch_settings.biometric_device,sch_settings.phone,sch_settings.kota,sch_settings.ketua,languages.language,
    ...
    {
        $kota = $this->db->select('kota')->from('sch_settings')->where('id', '1')->get()->row_array();
        echo $kota['kota'];
    }
