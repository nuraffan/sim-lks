...
class Schsettings extends Admin_Controller
{
    ...
    public function ajax_schedit()
    {
        ...
        $this->form_validation->set_rules('sch_kota', $this->lang->line('kota'), 'trim|required|xss_clean');
        $this->form_validation->set_rules('sch_ketua', $this->lang->line('ketua'), 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            $data = array(
                ...
                'sch_kota' => form_error('sch_kota'),
                'sch_ketua' => form_error('sch_ketua'),
            ...
            $data = array(
                ...
                'kota' => $this->input->post('sch_kota'),
                'ketua' => $this->input->post('sch_ketua'),
